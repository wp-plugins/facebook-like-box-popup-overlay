...
$cvalue = 'set';
setcookie("cookie_fplike", $cvalue, time()+3600);  /* expire in 1 hour */
?>
...
<div class="addauth">
  <a href="#" class="close top5" onclick="closeregnew()"><img src="<?php echo plugins_url(); ?>/facebook-like-box-popup-overlay/images/close.png" alt="close"></a>
